  ...
  return (
    <div className="flex min-h-screen bg-bg">
      ...
      `}>
        ...
        {/* User + sign out */}
        {user && (
          <div className="px-3 pb-1 pt-3 border-t border-border-light mx-0 mt-2">
            <div className="flex items-center gap-2 px-2 py-2 rounded-[7px]">
              ...
              <p className="text-[11.5px] text-muted truncate flex-1">{user.email}</p>
              <button
                onClick={signOut}
                title="Sign out"
                className="p-1 rounded-[5px] text-faint hover:text-danger hover:bg-danger-light transition-colors flex-shrink-0"
              >
...
function SignOutIcon(p) { return <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg> }
