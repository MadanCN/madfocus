...
const CODES = [
  {
    id: 'kind', title: 'Be Kind', icon: '💚',
    full: "You don't know what another person is going through. We see the choices people make, but not the options they had. Always choose kindness and be slow to judge.",
  },
  {
    id: 'just', title: 'Just Do It', icon: '⚡',
    full: "You rarely regret the things you did; you regret the things you didn't. Every time you think, \"I wish I had done this when I was younger,\" remember: today is the youngest you will ever be. Do it now.",
  },
  {
    id: 'windows', title: 'Create Windows', icon: '🪟',
    full: "We all live within the limits of our own perspective. Every skill you learn, book you read, place you visit, and person you meet opens a new window through which to experience life. Create as many windows as you can.",
  },
  {
    id: 'word', title: 'Keep Your Word', icon: '🤝',
    full: "The promises you make to yourself are just as important as the promises you make to others. Say less, do more, and let your actions speak for your character.",
  },
  {
    id: 'courage', title: 'Courage Over Comfort', icon: '🔥',
    full: "Growth rarely happens inside your comfort zone. When faced with a choice between what is easy and what is meaningful, choose the meaningful path.",
  },
  {
    id: 'die', title: 'Remember You Will Die', icon: '⏳',
    full: "Life is finite. Let that awareness sharpen your priorities, not frighten you. Focus on what will matter when you look back on your life.",
  },
  {
    id: 'grateful', title: 'Be Grateful', icon: '🙏',
    full: "Most things you take for granted today were once things you wished for. Ambition moves you forward; gratitude lets you enjoy the journey. Appreciate the people, experiences, and opportunities that make life worth living.",
  },
]
        ...
        {CODES.map(c => (
          <div key={c.id} className="relative">
            ...
            {expanded === c.id && (
              ...
              >
                <p className="font-semibold mb-1.5 flex items-center gap-1.5">{c.icon} {c.title}</p>
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-col gap-1">
                {entries.slice(0, 6).map(e => (
                  ...
                  >
                    <span className="text-[14px]">{e.emotions?.length > 0 ? '🎭' : '📝'}</span>
